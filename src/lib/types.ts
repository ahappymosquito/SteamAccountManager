...
export type SoftwareStatus = { code:"steam"|"perfectworld"|"5e"|"teamspeak3"; name:string; installed:boolean; executablePath?:string; downloadMode:"managed"|"browser_fallback"; officialUrl:string };
