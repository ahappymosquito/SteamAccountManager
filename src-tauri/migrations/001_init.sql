...
CREATE TABLE IF NOT EXISTS platform_accounts (id TEXT PRIMARY KEY, platform_code TEXT NOT NULL, external_id TEXT, display_name TEXT, profile_url TEXT, login_account TEXT, login_password TEXT, remark TEXT, status TEXT NOT NULL DEFAULT 'unverified', binding_method TEXT NOT NULL DEFAULT 'manual', last_verified_at TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);
